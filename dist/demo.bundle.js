/******/ (() => {
  ...
  \**********************/
        ...
        function setFields() {
            ...
            currentMatrix = (0, _util__WEBPACK_IMPORTED_MODULE_3__.toMatrix)(
                originalData
            );
        }
        ...
        document.querySelector('#laplace').addEventListener('click', function () {
            matrixStack.push(currentMatrix);
            currentMatrix = (0, _filters__WEBPACK_IMPORTED_MODULE_1__.laplaceMask)(
                currentMatrix
            );
            reload();
        });
        ...
        document.querySelector('#hysteresis').addEventListener('click', function () {
            ...
            currentMatrix = (0, _filters__WEBPACK_IMPORTED_MODULE_1__.hysteresis)(
                currentMatrix,
                (0, _util__WEBPACK_IMPORTED_MODULE_3__.clamp)(high, 0, 1),
                (0, _util__WEBPACK_IMPORTED_MODULE_3__.clamp)(low, 0, 1)
            );
            reload();
        });
